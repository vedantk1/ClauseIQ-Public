...
export default function LegacyAnalysis() {
  ...
  return <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
    <header className="space-y-3">
      <p className="text-sm text-text-muted font-medium">Earlier analysis workflow</p>
      <h1 className="font-heading text-3xl md:text-4xl font-semibold">Upload for earlier analysis</h1>
      <p className="text-text-secondary text-lg">This separate workflow creates the earlier clause analysis, summaries, rewrites and document chat. Existing results remain available.</p>
      <p className="text-text-secondary">For the current review workspace, <Link href="/import" className="text-accent-subtle underline underline-offset-4">import an agreement</Link> without AI first, then choose when to start a review.</p>
    </header>
